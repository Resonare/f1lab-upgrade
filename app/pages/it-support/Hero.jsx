...
import homeAnimationJson from "../../animations/service-it-support.json";
...
const Hero = () => {
  ...
  const content = {
    ...
    cards: [
      "Компетентная техподдержка и постоянный мониторинг для обеспечения стабильной работы и минимизации времени простоя",
    ],
  };
