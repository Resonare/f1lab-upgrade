  ...
  return (
    ...
    >
      <div className="col-start-1 col-end-5 xl:flex lg:grid flex max-lg:flex-col xl:gap-15 lg:gap-0 gap-15 items-stretch grid-cols-4">
        ...
        <div className="flex max-sm:flex-col max-sm:gap-[3px] items-stretch xl:basis-2/3 basis-1/2 [&>div>div]:h-full col-start-3 col-end-5">
          ...
          <div className="flex flex-col basis-1/2 gap-[3px] justify-between">
            <ContentCard className="bg-gray-400 rounded-[15px]">
              <div className="flex flex-col gap-15 text-gray-100">
                ...
                <p className="text-xl font-light font-text leading-normal">
                  Средняя зарплата системного администратора по данным habr.com
                </p>
                <div className="w-15">
                  <svg
                    className="max-sm:hidden"
