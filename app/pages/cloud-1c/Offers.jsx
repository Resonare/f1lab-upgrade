  ...
  return (
    <Section inverseColor={true} id="offers">
      ...
      <ContentCard
        ...
        iconPath="cloud-1c/offer-icon1.svg"
        inverseColor={true}
      >
        Организацию быстрой и эффективной совместной работы в 1С за счет
        высокопроизводительных серверов и грамотной организации инфраструктуры.
      </ContentCard>
      ...
      <ContentCard
        ...
        iconPath="cloud-1c/offer-icon2.svg"
        inverseColor={true}
      >
        role-based model организации <br />
        ит-инфраструктуры.
      </ContentCard>
