...
const Hero = () => {
  ...
  return (
    <div className="relative">
      ...
      <Section
        hero={true}
        className="2xl:border-gray-250 text-5xl font-title pb-60 whitespace-normal inline-block w-full h-full"
      >
        <div className="text-gray-400 row-start-1 col-start-1 2xl:col-end-4 col-end-5 text-[56px]">
        ...
        <div className="md:row-start-4 col-start-1 lg:col-end-2 col-end-3 flex max-sm:flex-col max-sm:gap-15 justify-between">
          <PrimaryButton
            row="h-full"
            type="dark-to-light"
