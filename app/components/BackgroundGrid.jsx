const BackgroundGrid = ({ inverseColor = false }) => {
  ...
  return (
    <>
      {inverseColor && (
        <div
          className={`max-sm:bg-dark-striped bg-gray-400 absolute -z-[9] grid grid-cols-4 max-w-[1920px] w-full h-full xl:px-120 lg:px-60 sm:px-[44.1px] px-15`}
        >
          <div
      ...
      {!inverseColor && (
        <div className="max-sm:bg-striped fixed top-[70px] xl:top-90 -z-10 grid grid-cols-4 max-w-[1920px] w-full h-full xl:px-120 lg:px-60 sm:px-[44.1px] px-15">
